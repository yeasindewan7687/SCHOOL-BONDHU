...
async function clear() {
      await supabase.from('processed_results').delete().neq('id', 0);
      await supabase.from('student_marks').delete().neq('id', 0);
      console.log('Cleared processed_results and student_marks!');
}
clear();
